<div class="witrfm_area">
  <div class="foter_call_area">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <img src="assets/images/Logo_simple_fond bleu_cite_dex.jpg" alt="Logo">
          <div class="tts">
            <div class="ttin text-center">
              <h2 class="txbdstitle sttwo hlight">Inscrivez-vous à notre newsletter</h2>
            </div>
          </div>
          <form class="mc4wp-form mc4wp-form-12748" method="post" data-id="12748">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-3">
          <div class="tts">
            <div class="ttin text-left">
              <h4 class="txbdstitle tsmall stone hlight txbdbcolor">Contact </h4>
              <p>En attente</p>
            </div>
          </div>
          <div class="witrlistw all_list_color">
            <h2>Faire un don par appel</h2>
            <ul>
              <li>
                <a href="#">
        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
          <div class="widget widget_recent_entries">
            <h2 class="widget-title">Découvertes </h2>
            <ul>
              <li>
                <a href="index.php#actualites" class="scroll-link">Actualités</a>
              </li>
              <li>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="copy-right-text text-center">
            <p> &copy; 2024 - Cité d'Ex - Tous droits réservés.</p>
          </div>
        </div>
      </div>
    </div>
