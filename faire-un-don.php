...
<head>
 <title>Faire un don - Cité d'Ex</title>
 <meta charset="utf-8">
 <meta name="format-detection" content="telephone=no">
 <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0,  user-scalable=0">
 <meta http-equiv="X-UA-Compatible" content="IE=Edge">
 <meta name="keywords" content="don, soutenir, soutient, entraide">
    ...
    <div class="col-md-12 txtc  text-center ccase">
     ...
     <div class="breadcumb-inner">
      <ul>
       ...
       <li><span class="current">Nous soutenir</span></li>
      </ul>
     </div>
    </div>
   </div>
    ...
    <div class="col-lg-6 col-md-6">
     <div class="apartment_area">
      <div class="apartment_text">
       <h4>Nous soutenir</h4>
       <h2>Votre soutien nous aide à placer l'homme au centre de l'univers et à agir ensemble pour un avenir meilleur.</h2>
      </div>
      <div class="witr_apartment_form">
       <form id="">
        ...
        <div class="row">
         ...
         <div class="col-lg-12">
          <div class="twr_form_box ">
           <input type="number" min="10" name="phone" placeholder="Montant en Euro*">
          </div>
         </div>
